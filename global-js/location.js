window.onload = function () {
    function mapBtnClick (btn, currentClass, img1,img2, group) {
        $(btn).click(function () {
            if ($(btn).hasClass(currentClass)) {
                ...
                group.options.set('visible', true);
            }
        })
    }

    function mapInit(){
        var placemark1, station1, station2, station3, station4,
            med1, med2, med3, med4, med5, med6, med7,
            mus1, mus2, mus3, mus4, mus5, mus6, mus7,
            park1, park2, park3, park4, park5, park6, park7, park8, park9, park10,
            teatr1, teatr2, teatr3, teatr4, teatr5, teatr6, teatr7,
            shop1, shop2, shop3, shop4, shop5, shop6, shop7, shop8, shop9, shop10,
            school1, school2, school3, school4, school5, school6, school7, school8, school9, school10, school11, school12, school13, school14, school15, school16,
        ...
        var mus = new ymaps.GeoObjectCollection({}, {});
        var parks = new ymaps.GeoObjectCollection({}, {});
        var teatrs = new ymaps.GeoObjectCollection({}, {});
        var shops = new ymaps.GeoObjectCollection({}, {});
        var schools = new ymaps.GeoObjectCollection({}, {});
        var metros = new ymaps.GeoObjectCollection({}, {});
        ...
        stations.add(station1).add(station2).add(station3).add(station4)
        med.add(med1).add(med2).add(med3).add(med4).add(med5).add(med6).add(med7);
        mus.add(mus1).add(mus2).add(mus3).add(mus4).add(mus5).add(mus6).add(mus7);
        parks.add(park1).add(park2).add(park3).add(park4).add(park5).add(park6).add(park7).add(park8).add(park9).add(park10);
        teatrs.add(teatr1).add(teatr2).add(teatr3).add(teatr4).add(teatr5).add(teatr6).add(teatr7);
        shops.add(shop1).add(shop2).add(shop3).add(shop4).add(shop5).add(shop6).add(shop7).add(shop8).add(shop9).add(shop10);
        schools.add(school1).add(school2).add(school3).add(school4).add(school5).add(school6).add(school7).add(school8).add(school9).add(school10).add(school11).add(school12).add(school13).add(school14).add(school15).add(school16);
        metros.add(metro1).add(metro2).add(metro3).add(metro4).add(metro5).add(metro6).add(metro7);
        ...
        parks.options.set('visible', false);
        teatrs.options.set('visible', false);
        ...
        mapBtnClick('#parkBtn','location-main__buttons_button-click', 'img/loc-map4.png','img/loc-map44.png', parks);
        mapBtnClick('#teatr','location-main__buttons_button-click', 'img/loc-map5.png','img/loc-map55.png', teatrs);
        mapBtnClick('#shops','location-main__buttons_button-click-opacity', 'img/loc-map6.png','img/loc-map66.png', shops);
        mapBtnClick('#schools','location-main__buttons_button-click-opacity', 'img/loc-map7.png','img/loc-map77.png', schools);
        mapBtnClick('#metro','location-main__buttons_button-click', 'img/loc-map8.png','img/loc-map88.png', metros);
    }
